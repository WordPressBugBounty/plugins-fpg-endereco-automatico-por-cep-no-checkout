...
1. No painel de administração do WordPress, vá para a seção 'Plugins' e clique em 'Adicionar Novo'.
2. Clique no botão 'Fazer upload do plugin'.
3. Selecione o arquivo zip do plugin ('fpg-endereco-automatico-por-cep-no-checkout.zip') e clique em 'Instalar agora'.
...
Para suporte, por favor utilize os fóruns de suporte do WordPress.org.
